...
export VM_SERVICE_ACCOUNT_NAME_TEST="${SYSTEM_NAME_ABBREVIATED}-${TEST}-gsa"
export VM_SERVICE_ACCOUNT_EMAIL_TEST="${VM_SERVICE_ACCOUNT_NAME_TEST}@${GCP_PROJECT_ID}.iam.gserviceaccount.com"
...
export VM_SERVICE_ACCOUNT_NAME_PROD="${SYSTEM_NAME_ABBREVIATED}-${PROD}-gsa"
export VM_SERVICE_ACCOUNT_EMAIL_PROD="${VM_SERVICE_ACCOUNT_NAME_PROD}@${GCP_PROJECT_ID}.iam.gserviceaccount.com"
